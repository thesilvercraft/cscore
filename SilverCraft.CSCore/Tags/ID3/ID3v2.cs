...
/// <summary>
/// Represents an ID3v2 tag structure, providing access to headers, footers, metadata frames, and other components of an audio file container.
/// </summary>
/// <remarks>
/// This class implements <see cref="IEnumerable{T}"/> allowing iteration over all contained metadata frames.
/// </remarks>
